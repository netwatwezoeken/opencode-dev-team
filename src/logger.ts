/*
* Taken from https://github.com/yuhp/opencode-models-discovery
* Licensed under MIT.
*/
...
export function createLogger(client?: PluginClient, baseExtra: LogExtra = {}): Logger {
  ...
  return {
    ...
    child(extra) {
      return createLogger(client, mergeExtra(baseExtra, extra) || {})
    },
  }
}