...
Per `.opencode/knowledge/plan-review-rubric.md` (Whole-file load: short, shared rubric). This agent also
...
Per `.opencode/knowledge/plan-review-rubric.md` (Whole-file load: short, shared rubric).
